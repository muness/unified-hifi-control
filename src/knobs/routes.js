...
async function openConfig(knobId) {
  ...
  document.getElementById('configForm').innerHTML = '<form id="knobConfigForm">' +
    ...
    '<tr><td>Art Mode</td><td><input type="number" name="art_chg_sec" value="' + artChg.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="art_chg_on"' + (artChg.enabled ? ' checked' : '') + '> On</label></td><td><input type="number" name="art_bat_sec" value="' + artBat.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="art_bat_on"' + (artBat.enabled ? ' checked' : '') + '> On</label></td></tr>' +
    '<tr><td>Dim</td><td><input type="number" name="dim_chg_sec" value="' + dimChg.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="dim_chg_on"' + (dimChg.enabled ? ' checked' : '') + '> On</label></td><td><input type="number" name="dim_bat_sec" value="' + dimBat.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="dim_bat_on"' + (dimBat.enabled ? ' checked' : '') + '> On</label></td></tr>' +
    '<tr><td>Sleep</td><td><input type="number" name="slp_chg_sec" value="' + slpChg.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="slp_chg_on"' + (slpChg.enabled ? ' checked' : '') + '> On</label></td><td><input type="number" name="slp_bat_sec" value="' + slpBat.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="slp_bat_on"' + (slpBat.enabled ? ' checked' : '') + '> On</label></td></tr>' +
    '<tr><td>Deep Sleep</td><td><input type="number" name="dslp_chg_sec" value="' + dslpChg.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="dslp_chg_on"' + (dslpChg.enabled ? ' checked' : '') + '> On</label></td><td><input type="number" name="dslp_bat_sec" value="' + dslpBat.timeout_sec + '" style="width:50px;" min="1"> <label><input type="checkbox" name="dslp_bat_on"' + (dslpBat.enabled ? ' checked' : '') + '> On</label></td></tr></table></div>' +
